	...
	public final void field() throws RecognitionException, TokenStreamException {
		...
		if ((_tokenSet_4.member(LA(1))) && (_tokenSet_5.member(LA(2)))) {
			...
			default:
				...
				else if (((LA(1) >= TK_void && LA(1) <= IDENT)) && (_tokenSet_6.member(LA(2)))) {
					typeSpec(false);
					t_AST = (AST)returnAST;
					{
					if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
...
/** Catch obvious constructor calls, but not the expr.super(...) calls */
	...
	public final void statement() throws RecognitionException, TokenStreamException {
		...
		case TK_if:
		{
			...
			astFactory.addASTChild(currentAST, returnAST);
			{
			if ((LA(1)==TK_else) && (_tokenSet_10.member(LA(2)))) {
				match(TK_else);
				statement();
				astFactory.addASTChild(currentAST, returnAST);
			}
		...
		default:
			boolean synPredMatched18901 = false;
			if (((_tokenSet_13.member(LA(1))) && (_tokenSet_14.member(LA(2))))) {
				int _m18901 = mark();
				synPredMatched18901 = true;
				inputState.guessing++;
				try {
					{
					declaration();
					...
					synPredMatched18901 = false;
				}
				rewind(_m18901);
				inputState.guessing--;
			}
			if ( synPredMatched18901 ) {
				declaration();
				astFactory.addASTChild(currentAST, returnAST);
				match(SEMI);
				statement_AST = (AST)currentAST.root;
 ...
 */
	...
	public final void forInit() throws RecognitionException, TokenStreamException {
		...
		{
		boolean synPredMatched18919 = false;
		if (((_tokenSet_13.member(LA(1))) && (_tokenSet_14.member(LA(2))))) {
			int _m18919 = mark();
			synPredMatched18919 = true;
			inputState.guessing++;
			try {
				{
				declaration();
				...
				synPredMatched18919 = false;
			}
			rewind(_m18919);
			inputState.guessing--;
		}
		if ( synPredMatched18919 ) {
			declaration();
			astFactory.addASTChild(currentAST, returnAST);
		}
	...
	public final void casesGroup() throws RecognitionException, TokenStreamException {
		...
		_loop18910:
		do {
			if ((LA(1)==TK_case||LA(1)==TK_default) && (_tokenSet_21.member(LA(2)))) {
				aCase();
				astFactory.addASTChild(currentAST, returnAST);
			}
			else {
				if ( _cnt18910>=1 ) { break _loop18910; } else {throw new NoViableAltException(LT(1), getFilename());}
			}
	...
	public final void unaryExpressionNotPlusMinus() throws RecognitionException, TokenStreamException {
		...
		case NUM_DOUBLE:
		{
			...
			if ((LA(1)==LPAREN) && ((LA(2) >= TK_void && LA(2) <= TK_double))) {
				...
				boolean synPredMatched18979 = false;
				if (((LA(1)==LPAREN) && (LA(2)==IDENT))) {
					int _m18979 = mark();
					synPredMatched18979 = true;
					inputState.guessing++;
					try {
						{
						match(LPAREN);
						...
						synPredMatched18979 = false;
					}
					rewind(_m18979);
					inputState.guessing--;
				}
				if ( synPredMatched18979 ) {
					lp = LT(1);
		...
		if ((LA(1)==LPAREN)) {
			...
			do {
				if ((LA(1)==LBRACK) && (LA(2)==RBRACK)) {
					...
					if ( _cnt18997>=1 ) { break _loop18997; } else {throw new NoViableAltException(LT(1), getFilename());}
				}
	...
	public final void newArrayDeclarator() throws RecognitionException, TokenStreamException {
		...
		do {
			if ((LA(1)==LBRACK) && (_tokenSet_27.member(LA(2)))) {
				...
				if ( _cnt19007>=1 ) { break _loop19007; } else {throw new NoViableAltException(LT(1), getFilename());}
			}
