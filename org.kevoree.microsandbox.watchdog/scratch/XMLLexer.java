// $ANTLR 2.7.2: "xml.g" -> "XMLLexer.java"$
...
public class XMLLexer extends antlr.CharScanner implements XMLLexerTokenTypes, TokenStream
 {
...
tryAgain:
	...
	protected final void mWS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt20247>=1 ) { break _loop20247; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt20247++;
		} while (true);
	...
	protected final void mINTERNAL_DTD(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)==']') && (_tokenSet_6.member(LA(2))) && (true)) break _loop20198;
	...
	protected final void mCOMMENT_DATA(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			// nongreedy exit test
			if ((LA(1)=='-') && (LA(2)=='-') && (LA(3)=='>')) break _loop20207;
			if ((LA(1)=='\n'||LA(1)=='\r') && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				mNL(false);
			}
			else if (((LA(1) >= '\u0003' && LA(1) <= '\u00ff')) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
	...
	protected final void mPCDATA_DATA(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((LA(1)=='\n'||LA(1)=='\r')) {
				...
				if ( _cnt20220>=1 ) { break _loop20220; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	protected final void mCDATA_DATA(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = CDATA_DATA;
		int _saveIndex;
		...
		do {
			// nongreedy exit test
			if ((LA(1)==']') && (LA(2)==']') && (LA(3)=='>')) break _loop20224;
			if ((LA(1)=='\n'||LA(1)=='\r') && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
				mNL(false);
			}
			else if (((LA(1) >= '\u0003' && LA(1) <= '\u00ff')) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && ((LA(3) >= '\u0003' && LA(3) <= '\u00ff'))) {
