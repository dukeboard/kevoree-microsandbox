 ...
 * have no effect on the map.  For example, invoking the {@link #putAll(org.resourceaccounting.utils.Map)}
...
public interface Map<K,V> {
     ...
     *
     * @see org.resourceaccounting.utils.Map#entrySet()
     * @since 1.2
     */
    interface Entry<K,V> {
        /**
     ...
     * @see org.resourceaccounting.utils.Map.Entry#hashCode()
     * @see Object#equals(Object)
     * @see #equals(Object)
     */
    int hashCode();
